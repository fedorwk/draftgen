...
func setupServer() *http.Server {
	...
	router.HandleFunc("/", embeddedHTML)
	router.HandleFunc("/generate", generateDrafts)
...
func embeddedHTML(w http.ResponseWriter, r *http.Request) {
	if EmbeddedHTML == nil {
...
func generateDrafts(w http.ResponseWriter, r *http.Request) {
